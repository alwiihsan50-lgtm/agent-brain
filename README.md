...
| :--- | :--- | :--- | :--- |
| **STB Web Remote Hub** | `Port 8080` / `100.122.66.85:8080` | 🟢 Live | Streamlined 3-Tab Hub: Remote, Apps (Official YouTube TV, TV Bro, Tailscale), Settings, Ad & Adult Filter 167k+ domains, HDMI 1080p, Aria2 24/7 Engine `Port 6800` & `stb-torrent`. |
...
**Last Updated At:** 2026-08-30 23:05 WIB
