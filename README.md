...
| **MT5 Dual Container** | `Port 3000` (Acc 1) / `Port 3006` (Acc 2) | 🟢 Acc 1 Live / ⚪ Acc 2 Off | Acc 1 M5 Solo Gold aktif (v5.0 Model C: Target R:R 1:1.5 + Soft Risk Cut -0.5R @ +1.0R, Clamp Max SL Rp 100rb). Acc 2 dinonaktifkan sementara. |
...
- [ ] **Deployment Akun 1 MT5 Solo Gold (v5.0-RR15-SOFT-CUT): Model C (Target R:R 1:1.5, Soft Risk Halving -0.5R @ +1.0R, Rejection Filter, Max SL Clamp Rp 100rb, Validasi Net +Rp 10.8M Win Rate 77.1% TP / 85.7% Bebas Rugi, Max DD Rp 228rb)** ⚠️ [MENUNGGU KONFIRMASI USER]
