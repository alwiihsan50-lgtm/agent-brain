...
| **MT5 Dual Container** | `Port 3000` (Acc 1) / `Port 3006` (Acc 2) | 🟢 Acc 1 Live / ⚪ Acc 2 Off | Acc 1 M5 Solo Gold aktif (v5.1 Target R:R 1:3 + Two-Stage Guard: Soft -0.5R @ +1.0R -> Lock +0.3R @ +1.5R, Clamp Max SL Rp 100rb). Acc 2 dinonaktifkan sementara. |
...
**Last Updated At:** 2026-09-16 22:50 WIB
