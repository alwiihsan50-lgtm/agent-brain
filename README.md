...
| **MT5 Dual Container** | `Port 3000` (Acc 1) / `Port 3006` (Acc 2) | 🟢 Acc 1 Live / ⚪ Acc 2 Off | Acc 1 M5 Solo Gold Cent aktif (Exness Cent `263301611` - `XAUUSDc`, v5.1 Target R:R 1:3 + Two-Stage Guard, Sizing Dinamis Flat Risk Rp 50.000 / ~303 USC). Acc 2 dinonaktifkan sementara. |
...
**Last Updated At:** 2026-09-17 01:00 WIB
