...
- **Last Updated At:** 2026-08-14 01:11 WIB
...
- [x] Pendokumentasian batasan lingkungan sistem & reserved port (Port 40506 TailShare) di `docs/system-environment-and-ports.md`
...
1. **Arsip-IMO Project:** Berada di branch `Beta2-redesign` (`D:\Documents\GitHub\Arsip-IMO`). Aplikasi karyawan React 19 + Supabase + Zustand. Layout kontrol kalender menggunakan grid 2x2 dengan font `12px`.
2. **Katalog Proyek Drive D (`D:\Projects`):** Terdiri dari 18 repositori Git aktif termasuk ekosistem IMO, SmartHome, SaveBuddy, SIMPKK Digital, PRD Generator, dan Ekosistem LPKP Mentari.
3. **Lingkungan & Service:** Port `40506` dikunci untuk server **TailShare**. Jangan mengikat dev server ke port ini.
4. **Akun & Akses GitHub:** Terhubung ke `alwiihsan50-lgtm` via GitHub CLI (`gh`) HTTPS protocol.
