...
| **MT5 Dual Container** | `Port 3000` (Acc 1) / `Port 3006` (Acc 2) | 🟢 Running | Dual-instance Pure SMC v4.3: Acc 1 M5 Multi-Pair & Acc 2 M1 Gold Only Dual-Direction (BUY & SELL), Flat Risk Rp 50rb, TP Spread Buffer calibrated. |
