...
| **MT5 Dual Container** | `Port 3000` (Acc 1) / `Port 3006` (Acc 2) | 🟢 Acc 1 Live / ⚪ Acc 2 Off | Acc 1 Triple-Bot aktif (Demo USD `463978832` / Cent `263301611` - `XAUUSDm/c`): **Trending** Doji+MACD R:R 1:3.0 (D1 ATR >= $40, ADX 20-50, pause London Lunch 17-19 WIB), **Sideways** BB 2.5 + RSI7 R:R 1:1.8 (Sesi Prima 14-00 WIB), **Daily** Doji D1 1-Bar Exit. Sizing Flat Risk M5 **Rp 20.000** & D1 **Rp 50.000**. Portofolio backtest 17.5 bulan: 17/18 bulan hijau (94.4%), PF 1.50, DD Rp 426k (-22%). Acc 2 dinonaktifkan sementara. |
...
**Last Updated At:** 2026-09-24 19:38 WIB
